...
Bienvenid@ a 
*${mdata.subject}* Joder que bueno verte poraquí😉,Espero la pases súper en este grupo😎Da un vistazo qlas reglas evitar malentendidos🗡️
...
case 'ig':
  ...
  lagu = await getBuffer(anu.result)
  Lxa.sendMessage(from, lagu, video, {
mimetype: 'video/mp4', filename: `𝒔𝒂𝒎𝒖𝒓𝒂𝒊.mp4`, quoted: mek
  })
